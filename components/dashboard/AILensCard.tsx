/**
 * @file AILensCard.tsx
 * @description Glassmorphism card displaying AI-powered carbon footprint insights,
 * recommended actions, and potential monthly savings.
 *
 * @module Components
...
import { useAILens } from '@/hooks/useAILens';
import { useCarbon } from '@/context/CarbonContext';

/**
 * Renders the AI analysis card with observations, recommended actions,
 * and animations (pulse and typewriter effects).
 * @returns React element for the AI Lens Card, or null if no user profile is active.
 */
export default function AILensCard() {
  ...
  // Format remaining rate limit time (in seconds) as mm:ss
  ...
  // Build the state status pill dynamically based on current API/caching state
  const getStatusIndicator = (): React.ReactElement => {
    switch (status) {
      case 'loading':
        return (
